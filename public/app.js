...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
var ajaxServer = function ajaxServer(term) {
  var url = "https://api.postit.lt/?term=";
  var key = "7DCmhEg4L5ACmPNWnmfA";
  return fetch("".concat(url).concat(term, "&key=").concat(key)).then(function (response) {
    return response.json();
  });
};

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ajaxServer);
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunk_2021_11_19_modern"] = self["webpackChunk_2021_11_19_modern"] || [];
